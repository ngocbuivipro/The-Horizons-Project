...
import {createCarRouteApi, getAllCarsApi} from "../../../api/client/car.api.js";
import toast from "react-hot-toast";
import {Select} from "antd";

const AdminCreateRouteTransfer = () => {
    ...
    // Store fetched vehicles from API
    ...
    useEffect(() => {
        const fetchVehicles = async () => {
            try {
                // Fetch active vehicles to populate the library
                const res = await getAllCarsApi({ status: 'ACTIVE' });
                if (res && res.success) {
                    setLibraryVehicles(res.data);
                } else {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            // 3. API Call
            const res = await createCarRouteApi(payload);
        ...
        <div className="min-h-screen bg-gray-50 p-6 font-sans text-gray-800">
            ...
            <header className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="text-2xl font-bold text-gray-800">Create Transfer Route</h1>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        {libraryVehicles.length === 0 && (
                            <div className="col-span-full text-center py-6 text-gray-400 border border-dashed rounded-lg">
                                No vehicles found. Please create vehicles in the Vehicle menu first.
                            </div>
                        )}
                    </div>
                )}
...
export default AdminCreateRouteTransfer;